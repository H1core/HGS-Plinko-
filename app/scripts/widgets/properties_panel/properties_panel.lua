local property_checkbox = require("app.scripts.widgets.properties_panel.properties.property_checkbox")
local property_slider = require("app.scripts.widgets.properties_panel.properties.property_slider")
local property_button = require("app.scripts.widgets.properties_panel.properties.property_button")
local property_input = require("app.scripts.widgets.properties_panel.properties.property_input")
local property_text = require("app.scripts.widgets.properties_panel.properties.property_text")
local property_left_right_selector = require("app.scripts.widgets.properties_panel.properties.property_left_right_selector")
local property_vector3 = require("app.scripts.widgets.properties_panel.properties.property_vector3")
...
function M:init()
	...
	self.drag = self.druid:new_drag("header", self.on_drag_widget)
...
function M:on_drag_widget(dx, dy)
	...
	self.container:set_position(position.x + dx * scale.x, position.y + dy * scale.y)
end
...
function M:on_size_changed(new_size)
	...
	self.default_size = vmath.vector3(new_size.x, new_size.y + self.size_add, 0)
